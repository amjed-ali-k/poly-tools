...
const COLORS_BY_DIFFICULTY: { [key: string]: string } = {
  ...
  return (
    ...
    >
      ...
      <div className="flex gap-3">
        ...
        <div className="flex w-fit items-center justify-center rounded-full bg-transparent bg-zinc-300 px-2.5 py-1 pl-1.5 pr-2 text-xs font-bold text-slate-700 duration-300 group-hover/card:-translate-x-1 group-hover/card:-translate-y-1 group-hover/card:shadow-[0.5rem_0.5rem_0.25rem_-0.25rem_#0004] dark:bg-slate-700 dark:text-white">
          @{username}
        </div>
      </div>
      <div className="translate-x-1 text-xs">{prompt}</div>
      <div className="mt-4 h-56 flex-grow rounded-xl bg-zinc-300/70 p-4 duration-300 group-hover/card:-translate-x-1 group-hover/card:-translate-y-3 group-hover/card:shadow-[1rem_1rem_2.5rem_-1rem_#0008] dark:bg-slate-800/70">
        <svg
          fill="none"
          height="193"
          viewBox="0 0 256 193"
